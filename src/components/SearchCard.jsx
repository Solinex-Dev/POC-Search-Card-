                ...
                <div className='flex flex-row items-center justify-center gap-3'>
                    <div className='relative flex-1'>
                        ...
                        <div className='relative'>
                            ...
                            <button 
                                className='absolute right-1 top-1/2 transform -translate-y-1/2 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-md p-2 w-20 h-10 flex justify-center items-center shadow-md hover:shadow-lg transition-all duration-300'
                    ...
                    <button 
                        className='bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-lg p-3 w-14 h-12 flex justify-center items-center shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105'
                    ...
                    <div className='bg-gradient-to-br from-white to-gray-50 border border-gray-200 rounded-xl p-6 shadow-xl'>
                        ...
                        <div className='flex flex-wrap gap-3'>
                            {categories.map(category => (
                                <button
                                    key={category.id}
                                    className={`px-6 py-3 rounded-full text-sm font-semibold transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg ${
                    ...
                    matchingCards.map((card, index) => {
                     ...
                     return (
                         ...
                         >
                             ...
                             <p className={`text-xs mt-2 text-center px-2 leading-tight ${
                                 isTopMatch 
                                     ? 'text-yellow-700' 
                                     : isMatching 
                                         ? 'text-blue-700' 
